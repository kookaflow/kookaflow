import { c as createServerRpc } from "./createServerRpc-DyrrqNkY.js";
import { z } from "zod";
import { r as requireSupabaseAuth } from "./auth-middleware-DPkeKsny.js";
import { s as supabaseAdmin } from "./client.server-U_pH-Evd.js";
import { s as syncUserCalendar, p as pushEventToGoogle, d as deleteEventFromGoogle, a as signState, G as GOOGLE_SCOPES } from "./google-calendar.server-BWC_r5to.js";
...
const getGoogleAuthUrl = createServerFn({
  ...
  const {
    getRequest
  } = await import("./server-C2wY1lzD.js");
